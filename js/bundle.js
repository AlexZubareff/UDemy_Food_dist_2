...
function forms(formSelector, modalTimerId) {
  ...
  function showThanksModal(message) {
    var prevModalDialod = document.querySelector('.modal__dialog');
    prevModalDialod.classList.add('hide');
    ...
    setTimeout(function () {
      thanksModal.remove();
      prevModalDialod.classList.add('show');
      prevModalDialod.classList.remove('hide');
...
function slider(_ref) {
  ...
  next.addEventListener('click', function () {
    if (offset == strOnlyDigit(width) * (slides.length - 1)) {
      offset = 0;
    } else {
      offset += strOnlyDigit(width);
    }
  ...
  prev.addEventListener('click', function () {
    if (offset == 0) {
      offset = strOnlyDigit(width) * (slides.length - 1);
    } else {
      offset -= strOnlyDigit(width);
    }
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      ...
      slideIndex = slideTo;
      offset = strOnlyDigit(width) * (slideTo - 1);
      slidesFiled.style.transform = "translateX(-".concat(offset, "px)");
      currentSlideIndex();
      changeDotsOpacity(dots);
    });
...
/* harmony import */ var _modules_cards__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/cards */ "./js/modules/cards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.timer', '2021-09-30');
  ...
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_8__["default"])();
});
})();
